    ...
    <div className="grid g2" style={{ gridTemplateColumns: "1fr 360px", alignItems: "start" }}>
      <div className="card">
        ...
        <div className="tblwrap"><table>
          ...
          <tbody>{S.ledger.map(l => <tr key={l.id} className="rowhov">
        ...
        {!S.ledger.length && <div className="muted" style={{ padding: "28px 0", textAlign: "center", fontSize: 13 }}>No ledger entries yet.</div>}
      </div>
      <div className="card">
